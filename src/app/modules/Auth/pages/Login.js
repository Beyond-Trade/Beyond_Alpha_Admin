...
const initialValues = {
  email: "admin@stripes.com",
  password: "admin@stripes.com",
};
          ...
          .then((res) => {
            ...
            firebase
              ...
              .then((docRef) => {
                ...
                if (docRef.data().role === "admin") {
                  console.log("in if ");
                  firebase
              .firestore()
              .collection("users")
              .doc(res.user.uid).set({isActive:true}, { merge: true })
                  disableLoading();
                  ...
                  console.log("out side if and else ");
                } else {
                  disableLoading();
                  setSubmitting(false);
                  setStatus(
        ...
        {formik.status ? (
          ...
          <div className="mb-10 alert alert-custom alert-light-info alert-dismissible">
            <div className="alert-text ">
              Use account <strong>admin@stripes.com</strong> and password{" "}
              <strong>admin@stripes.com</strong> to continue.
            </div>
          </div>
        )}
